...
\frametitle{What \emph{is} functional programming?}

\begin{itemize}
\item Programming with functions?
\item ...with higher-order functions?
\item ...with immutable data structures?
\item Writing Haskell in disguise? 
\end{itemize}
...
\end{itemize}
\item There are many dimensions of software quality that functional programming can't address
\begin{itemize}
\item That's okay and even good!
\end{itemize}
\end{itemize}
